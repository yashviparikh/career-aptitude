tech_skill_preferences_data = {
    ...
    "Cloud & DevOps": {
        "skills": [
            ...
            "Ansible", "Jenkins", "Linux Administration", "Cloud Security", "Serverless Architecture"
        ],
        "domains": {
    ...
    "Networking & Security": {
        "skills": [
            "Network Security", "Routing", "Firewall Configuration", "VPN Setup", "Cryptography",
            "Penetration Testing", "Incident Response", "Disaster Recovery", "Cyber Threat Intelligence", "Wireless Networking"
        ],
        "domains": {
            "Cybersecurity": {
                "roles": [
    ...
    "UI/UX & Design": {
        "skills": [
            "UI/UX Design", "Figma", "Sketch", "Adobe XD", "Wireframing", "User Research",
            "Prototyping", "Interaction Design", "User Testing", "Motion Design"
        ],
        "domains": {
            "UI/UX Design": {
                "roles": [
    ...
    "Leadership & Management": {
        "skills": [
            "Agile", "Scrum", "Project Management", "Tech Leadership", "Product Management",
            "Risk Management", "Team Building", "Communication", "Strategic Planning"
        ],
        "domains": {
